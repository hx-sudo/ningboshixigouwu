...
public class RegisterFragment extends BaseFragment {
    EditText telEt,nicknameEt,pwdEt,repwdEt;//电话号码，昵称，密码确认密码，
    Button ensurebutton;

    //切换界面用
    TextView logintv, regtv;//登录，注册
    ViewPager loginregvp;//适配器视图滑动，展示fragment
    ...
    private void initView(View view) {
        ...
        //切换界面用
        logintv = view.findViewById(R.id.login_tv_log);
        regtv = view.findViewById(R.id.reg_tv_log);
        loginregvp = view.findViewById(R.id.loginreg_vp);
    ...
    View.OnClickListener onClickListener=new View.OnClickListener() {
        ...
        public void onClick(View v) {
            ...
            //数据格式判断
            boolean flag=judgeInput( tel, nickname, pwd, repwd);
            if (flag) {
                //可执行网络请求,添加网络请求权限，
...
//                                regtv.setTextColor(Color.WHITE);
    ...
    /*数据格式判断
    * */
    private boolean judgeInput(String tel,String nickname,String pwd,String repwd) {

        //大陆电话号码正则表达式
        String regex="^1(?:3\\d|4[4-9]|5[0-35-9]|6[67]|7[013-8]|8\\d|9\\d)\\d{8}$";
        if (TextUtils.isEmpty(tel)||TextUtils.isEmpty(nickname)||TextUtils.isEmpty(pwd)||TextUtils.isEmpty(repwd))
        {   //输入为空判断
